...
<script type="text/javascript">
	...
	//Mengambil data dari database dan melakukan looping untuk menampilkan marker sesuai kordinat pada database
			$sql="select * from pengiriman order by nama";
		...
		?>
			...
			marker.setIcon({ url: "images/mobil.png", scaledSize: new google.maps.Size(30, 24) , anchor: new google.maps.Point(15, 12)});
			markers.push(marker);
