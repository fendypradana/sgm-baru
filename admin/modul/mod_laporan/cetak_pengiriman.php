...
$pdf->addText(250, 820, 20,'<b>Pengiriman</b>');
$pdf->addText(200, 800, 18,'<b>Surya Gemilang Motor</b>');
...
$sql = mysql_query("SELECT orders.id_orders as faktur,DATE_FORMAT(tgl_order, '%d-%m-%Y') as tanggal,
                    nama_produk,jumlah,harga,nama_lengkap 
...
$pdf->ezText("\nJumlah pengiriman : {$jml} unit");
$pdf->ezText("Jumlah keseluruhan pengiriman: {$totqu} unit");
